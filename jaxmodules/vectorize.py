...
def array_from_coords(shape: Tuple[int, ...], fn: Callable[..., Array]) -> Array:
    ...
    return multi_vmap(
        fn,
        in_axes=in_axes,
        out_axes=tuple(range(len(shape)))
    )(*args)
        

def multi_vmap(fn: Callable[..., Array], in_axes: List[Tuple[Union[int, None], ...]], out_axes: Tuple[int, ...]) -> Callable[..., Array]:
...
def multi_vmap_transposed_in_axes(fn: Callable[..., Array], in_axes: List[Tuple[Union[int, None], ...]], out_axes: Tuple[int, ...]) -> Callable[..., Array]:
